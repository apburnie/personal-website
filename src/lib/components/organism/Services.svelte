<script lang="ts">
	import SmartBox from '$lib/components/organism/SmartBox.svelte';
</script>
...
<category-container>
	...
	<SmartBox heading="Meso: Reusable, Modular Components" id="meso">
	...
	<SmartBox heading="Micro: Event Handling and Transactions" id="micro">
		<h4>Blockchain Tx</h4>
